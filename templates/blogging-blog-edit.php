    ...
    <div class="doctor-dashboard custom-large-container">
        ...
        <div class="doctor-dashboard__wrapper">
            ...
            <div class="doctor-dashboard__wrapper__header pt-5">
                ...
                <h2><?php echo (isset($_GET['post_id'])) ? 'Edit Blog' : 'New Blog'; ?></h2>

                <div class="doctor-dashboard__wrapper__header__cta">

                    <a href="#" <?php echo (isset($_GET['post_id']) && get_post_status($_GET['post_id']) == 'publish') ? 'onclick="showArticleDraftModal()"' : 'onclick="FormSubmit( \'draft\' )"'; ?> id="js-draft-article" class="btn-save btn btn-primary">Save Draft</a>

                    <button type="button" onclick="showArticlesModal()" id="js-publish-article" class="btn-save btn btn-secondary">Publish Blog</button>
            ...
            <div class="doctor-dashboard__wrapper__body">
                ...
                <?php if (isset($_GET['post_id'])) {
                    $data = Blog_ArticleEdit::get_article(1, $_GET['post_id']);
                } ?>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-xs-12 col-md-5">
                            ...
                            <div class="featured-image d-none flex-column justify-content-center align-items-center" id="js-doctorpedia-choose" style="background-image: url(<?php echo (isset($data)) ? $data['thumbnail'] : ''; ?>);">
                                ...
                                <label for="js-featured-image" style="margin-bottom: 0">
                    ...
                    <div class="form-group form-group--mtop">
                        ...
                        <div class="d-flex justify-content-between mb-3">
                            ...
                            <?php if (isset($_GET['post_id'])): ?>
                                ...
                                <a href="<?php echo '../preview/?post=' . $_GET['post_id'] . '&preview=true'; ?>" target="_blank" class="form-group__cta">Preview Blog</a>
                            ...
                            <?php else: ?>
                                ...
                                <a
                                    ...
                                    onclick="FormSubmit('draft', 'preview')"'
                                >
                                    Preview Blog
                                </a>
                ...
                <div class="doctor-dashboard__wrapper__header__cta doctor-dashboard__wrapper__footer-cta-container d-flex <?php echo (wp_is_mobile())? 'justify-content-center':'justify-content-end';?>">
                    ...
                    <a href="#" <?php echo (isset($_GET['post_id']) && get_post_status($_GET['post_id']) == 'publish') ? 'onclick="showArticleDraftModal()"' : 'onclick="FormSubmit( \'draft\' )"'; ?> id="js-draft-article" class="btn btn-primary">Save Draft</a>

                    <button type="button" onclick="showArticlesModal()" id="js-publish-article" class="btn btn-secondary">Publish Blog</button>
...
<?php require_once __DIR__ . '/parts/modal-new_blog.php';?>

<?php require_once __DIR__ . '/parts/modal-new_blog_pending.php';?>

<?php require_once __DIR__ . '/parts/modal-publish_to_draft_blog.php';?>

<?php require_once __DIR__ . '/parts/modal-draft-blog.php';?>
