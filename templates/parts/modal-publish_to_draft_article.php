<div class="shadow doctors-shadow d-none" id="js-draft-article-modal">
    ...
    <div class="doctors-add-review-modal modal-new_article d-flex align-items-center">
        ...
        <div class="modal-new_article__box d-flex flex-column align-items-center text-center position-relative js-confirm-modal">
            ...
            <p class="modal-new_article__box-copy">By saving this article as a draft, the article will no longer be visible for the public. You'll still be able to see, edit and publish it again whenever you are ready. </p>
            ...
            <div class="modal-new_article__box-cta-container d-flex">
                ...
                <button type="button" onClick="openVerifiedDraftArticleModal()" class="modal-new_article__box-cta" id="js-open-verified">Save Draft</button>
