<div class="shadow doctors-shadow d-none" id="js-pending-article-modal">
    ...
    <div class="doctors-add-review-modal modal-new_article d-flex align-items-center">
        ...
        <div class="modal-new_article__box d-flex flex-column align-items-center text-center position-relative js-pending-modal">
            ...
            <h2 class="modal-new_article__box-title">Your article has been sent for review</h2>

            <p class="modal-new_article__box-copy">Once the Doctorpedia editorial team reviews and approves your article,<br>you will see it in the <b>"Published"</b> tab and on your public profile.</p>

            <div class="modal-new_article__box-cta-container d-flex">

                <a href="<?php echo esc_url( home_url( 'doctor-platform/article-edit/' ) ); ?>" type="button" class="modal-new_article__box-cta hide-modal">Write Another Article</a>
