<div class="shadow doctors-shadow d-none" id="js-insert-article-modal">
    ...
    <div class="doctors-add-review-modal modal-new_article d-flex align-items-center">
        ...
        <div class="modal-new_article__box d-flex flex-column align-items-center text-center position-relative js-confirm-modal">
            ...
            <h2 class="modal-new_article__box-title">Are you sure you want to publish the Blog?</h2>

            <p class="modal-new_article__box-copy">When you click “Publish”, a Doctorpedia editor will review the blog before publishing. Is your blog ready for review?</p>

            <div class="modal-new_article__box-cta-container d-flex">

                <button type="button" onClick="openVerifiedLinkModal()" class="modal-new_article__box-cta" id="js-open-verified">Publish</button>
